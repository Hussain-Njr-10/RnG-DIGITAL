...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      style.textContent = `
        .cursor-target, .js-menu-link, .cyber-toggle, .cyber-nav__link {
    ...
    const enterHandler = e => {
      ...
      gsap.killTweensOf(cursorRef.current, 'rotation,opacity');
      spinTl.current?.pause();
      gsap.set(cursorRef.current, { rotation: 0 });
      gsap.to(cursorRef.current, { opacity: 1, duration: hoverDuration, ease: 'power2.out' });
